...
<body>
    ...
    <div class="continer">
        <div class="ends">
            ...
            $Id = $_GET['Id'];
            $sql_bag = mysqli_query($db, "SELECT*FROM user WHERE Id='$Id'");
            $inf_row = mysqli_fetch_array($sql_bag);
            ?>
            <span>نام کاربر:<?php echo $inf_row['Username'] ?></span>
            <span>ایمیل کاربر :<?php echo $inf_row['Email'] ?></span>
            <span>تلفن کاربر:<?php echo $inf_row['Phone'] ?></span>
            <span>آدرس کاربر:<?php echo $inf_row['Adress'] ?></span>
            <span>کد پستی کاربر:<?php echo $inf_row['Codepost'] ?></span>
