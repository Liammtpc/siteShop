        ...
        <div class="tagpage">
            ...
            <div class="pro-duct">
                ...
                while ($product_row = mysqli_fetch_array($sql_product)) {
                    echo '<div class="item_pro">
    <h4>' . $product_row['Title'] . '</h4>
    <p>' . $product_row['Execute'] . '</p>
    <div class="img-pro">
        <img src="' . $product_row['Img1'] . '" alt="">
        <img src="' . $product_row['Img2'] . '" alt="">
        <img src="' . $product_row['Img3'] . '" alt="">
    </div>
</div>
<div class="item_pro">
    <img src="' . $product_row['Img_main'] . '" alt="">
    <div class="down">
        <i class="fa-solid fa-down-long" onclick="display()"></i>
    </div>
</div>
<div class="item_pro">
    <span>' . $product_row['Price'] . ' ریال</span>
    <a href="card.php?Id=' . $product_row['Id']  . '&Ip=' . $user_ip . '"><button>خرید</button></a>
</div>';
                }
                ?>
            </div>
            <div class="info" id="info">
                <?php
                $db = mysqli_connect('localhost', 'root', '', 'shop');
                $sql_products = mysqli_query($db, "select*from product where 1");
                while ($products_row = mysqli_fetch_array($sql_products)) {
                    echo '<p>' . $products_row['Texts'] . '</p>';
                }
                ?>
            </div>
